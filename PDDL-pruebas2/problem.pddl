...
;         ;; Tiempos de vaciado (para costo)
;     (= (tiempo-vaciado t1-clinker) 0.72)
;     (= (tiempo-vaciado t2-clinker) 34.13)
...
;     (= (tiempo-vaciado t3-puzolana-s) 11.10)
;     (= (tiempo-vaciado t1-yeso) 11.25)
;     (= (tiempo-vaciado t2-yeso) 6.06)
;     (= (tiempo-vaciado t3-yeso) 1.1)
