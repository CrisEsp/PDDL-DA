...
(define (domain cement-alimentacion-durativo)
  ...
  (:durative-action alimentar-puzolana-h-MC1-por-MC2
    ...
    :effect (and
      ...
      (at end (molino-libre-pz-humeda ?m))
      ;; Metrica: T + V (OPTIC interpreta asi la suma)
      (at end (increase (costo-total) (+ (tiempo-acumulado-4) (tiempo-vaciado ?t))))
      (at end (increase (tiempo-acumulado-4) (tiempo-vaciado ?t)))
    )
  )
  ...
  (:durative-action alimentar-yeso-mc1-por-mc2
    ...
    :effect (and
      ...
      (at end (molino-libre-yeso ?m))
      (at end (increase (costo-total) (+ (tiempo-acumulado-3) (tiempo-vaciado ?t))))
      (at end (increase (tiempo-acumulado-3) (tiempo-vaciado ?t)))  ;; Updated to reflect the correct metric
    )
  )
