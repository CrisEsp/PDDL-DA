...
;     (= (tiempo-vaciado t2-puzolana-s) 0.8)
;     (= (tiempo-vaciado t3-yeso) 2.0)
;     (= (tiempo-vaciado t2-yeso) 1.8)
;     (= (tiempo-vaciado t1-puzolana-h) 0.9)
;     (= (tiempo-vaciado t1-yeso) 1.0)
...
;   (* 0.01 (tiempo-acumulado-ck))
;   (* 0.01 (tiempo-acumulado-pz-seca))
;   (* 25 (costo-tiempo-compartido-mc1))    ; ← De 0.01 a 25
;   (* 25 (costo-tiempo-compartido-mc2))    ; ← De 0.15 a 25
;   (* 25 (costo-tiempo-compartido-mc3))    ; ← De 0.15 a 25
;   (* 1 (total-time))                       ; ← De 20 a 1
