...
(:init
    ...
    (ruta-disponible mc3 t3-yeso yeso MC3-por-MC2)
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 37.21)
    (= (tiempo-vaciado t2-clinker) 39.08)
    (= (tiempo-vaciado t3-clinker) 38.68)
    (= (tiempo-vaciado t1-puzolana-h) 37.54)
    (= (tiempo-vaciado t2-puzolana-h) 33.82)
    (= (tiempo-vaciado t2-puzolana-s) 38.67)
    (= (tiempo-vaciado t3-puzolana-s) 38.31)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 28.98)
    (= (tiempo-vaciado t3-yeso) 23.67)
  )
