...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 2.73)
    (= (tiempo-vaciado t2-clinker) 2.31)
    (= (tiempo-vaciado t3-clinker) 0.35)
    (= (tiempo-vaciado t1-puzolana-h) 5.97)
    (= (tiempo-vaciado t2-puzolana-h) 15.01)
    (= (tiempo-vaciado t2-puzolana-s) 3.36)
    (= (tiempo-vaciado t3-puzolana-s) 0.01)
    (= (tiempo-vaciado t1-yeso) 9.62)
    (= (tiempo-vaciado t2-yeso) 11.22)
    (= (tiempo-vaciado t3-yeso) 11.83)
  )
