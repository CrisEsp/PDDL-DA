...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 2.64)
    (= (tiempo-vaciado t2-clinker) 4.42)
    (= (tiempo-vaciado t3-clinker) 4.10)
    (= (tiempo-vaciado t1-puzolana-h) 3.02)
    (= (tiempo-vaciado t2-puzolana-h) 0.01)
    (= (tiempo-vaciado t2-puzolana-s) 4.09)
    (= (tiempo-vaciado t3-puzolana-s) 3.92)
    (= (tiempo-vaciado t1-yeso) 9.21)
    (= (tiempo-vaciado t2-yeso) 6.65)
    (= (tiempo-vaciado t3-yeso) 20.90)
  )
