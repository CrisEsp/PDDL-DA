  ...
  (:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) -0.47)
    (= (tiempo-vaciado t2-clinker) -0.06)
    (= (tiempo-vaciado t3-clinker) -0.19)
    (= (tiempo-vaciado t1-puzolana-h) -0.28)
    (= (tiempo-vaciado t2-puzolana-h) -0.57)
    (= (tiempo-vaciado t2-puzolana-s) 0.28)
    (= (tiempo-vaciado t3-puzolana-s) -0.11)
    (= (tiempo-vaciado t1-yeso) -0.30)
    (= (tiempo-vaciado t2-yeso) 0.56)
