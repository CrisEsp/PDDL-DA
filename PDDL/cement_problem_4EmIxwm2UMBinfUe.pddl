...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 20.87)
    (= (tiempo-vaciado t2-clinker) 22.74)
    (= (tiempo-vaciado t3-clinker) 22.34)
    (= (tiempo-vaciado t1-puzolana-h) 21.20)
    (= (tiempo-vaciado t2-puzolana-h) 22.84)
    (= (tiempo-vaciado t2-puzolana-s) 22.33)
    (= (tiempo-vaciado t3-puzolana-s) 21.96)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 50.25)
    (= (tiempo-vaciado t3-yeso) 27.44)
  )
