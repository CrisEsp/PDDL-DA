...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 12.24)
    (= (tiempo-vaciado t2-clinker) 4.35)
    (= (tiempo-vaciado t3-clinker) 4.33)
    (= (tiempo-vaciado t1-puzolana-h) 9.48)
    (= (tiempo-vaciado t2-puzolana-h) 24.85)
    (= (tiempo-vaciado t2-puzolana-s) 5.55)
    (= (tiempo-vaciado t3-puzolana-s) 4.72)
    (= (tiempo-vaciado t1-yeso) 7.43)
    (= (tiempo-vaciado t2-yeso) 22.32)
