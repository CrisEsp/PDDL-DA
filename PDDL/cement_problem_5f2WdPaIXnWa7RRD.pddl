...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 1.69)
    (= (tiempo-vaciado t2-clinker) 3.56)
    (= (tiempo-vaciado t3-clinker) 3.16)
    (= (tiempo-vaciado t1-puzolana-h) 2.02)
    (= (tiempo-vaciado t2-puzolana-h) 12.21)
    (= (tiempo-vaciado t2-puzolana-s) 3.15)
    (= (tiempo-vaciado t3-puzolana-s) 2.78)
    (= (tiempo-vaciado t1-yeso) 3.36)
    (= (tiempo-vaciado t2-yeso) 30.56)
