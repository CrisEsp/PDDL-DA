...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 15.73)
    (= (tiempo-vaciado t2-clinker) 15.63)
    (= (tiempo-vaciado t3-clinker) 14.52)
    (= (tiempo-vaciado t1-puzolana-h) 22.25)
    (= (tiempo-vaciado t2-puzolana-h) 37.28)
    (= (tiempo-vaciado t2-puzolana-s) 17.40)
    (= (tiempo-vaciado t3-puzolana-s) 13.97)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 50.45)
    (= (tiempo-vaciado t3-yeso) 7.43)
  )
