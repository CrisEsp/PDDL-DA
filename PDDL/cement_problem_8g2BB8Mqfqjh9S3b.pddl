...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 15.03)
    (= (tiempo-vaciado t2-clinker) 11.79)
    (= (tiempo-vaciado t3-clinker) 11.35)
    (= (tiempo-vaciado t1-puzolana-h) 15.32)
    (= (tiempo-vaciado t2-puzolana-h) 29.37)
    (= (tiempo-vaciado t2-puzolana-s) 15.48)
    (= (tiempo-vaciado t3-puzolana-s) 13.79)
    (= (tiempo-vaciado t1-yeso) 59.00)
    (= (tiempo-vaciado t2-yeso) 37.41)
