...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 7.70)
    (= (tiempo-vaciado t2-clinker) 2.87)
    (= (tiempo-vaciado t3-clinker) 0.30)
    (= (tiempo-vaciado t1-puzolana-h) 9.04)
    (= (tiempo-vaciado t2-puzolana-h) 15.33)
    (= (tiempo-vaciado t2-puzolana-s) 2.60)
    (= (tiempo-vaciado t3-puzolana-s) 0.57)
    (= (tiempo-vaciado t1-yeso) 156.87)
    (= (tiempo-vaciado t2-yeso) 32.61)
    (= (tiempo-vaciado t3-yeso) 0.12)
  )
