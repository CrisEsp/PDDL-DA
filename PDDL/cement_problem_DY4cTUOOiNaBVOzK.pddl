...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 11.71)
    (= (tiempo-vaciado t2-clinker) 11.97)
    (= (tiempo-vaciado t3-clinker) 11.31)
    (= (tiempo-vaciado t1-puzolana-h) 16.37)
    (= (tiempo-vaciado t2-puzolana-h) 30.18)
    (= (tiempo-vaciado t2-puzolana-s) 10.58)
    (= (tiempo-vaciado t3-puzolana-s) 10.99)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 22.57)
    (= (tiempo-vaciado t3-yeso) 21.37)
  )
