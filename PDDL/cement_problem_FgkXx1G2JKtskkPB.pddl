...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 0.00)
    (= (tiempo-vaciado t2-clinker) 0.00)
    (= (tiempo-vaciado t3-clinker) 0.00)
    (= (tiempo-vaciado t1-puzolana-h) 0.00)
    (= (tiempo-vaciado t2-puzolana-h) 0.00)
    (= (tiempo-vaciado t2-puzolana-s) 0.00)
    (= (tiempo-vaciado t3-puzolana-s) 0.00)
    (= (tiempo-vaciado t1-yeso) 0.00)
    (= (tiempo-vaciado t2-yeso) 0.00)
    (= (tiempo-vaciado t3-yeso) 0.00)
  )
