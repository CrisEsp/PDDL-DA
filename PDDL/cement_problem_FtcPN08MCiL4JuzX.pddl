...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 24.06)
    (= (tiempo-vaciado t2-clinker) 14.59)
    (= (tiempo-vaciado t3-clinker) 15.11)
    (= (tiempo-vaciado t1-puzolana-h) 18.39)
    (= (tiempo-vaciado t2-puzolana-h) 32.14)
    (= (tiempo-vaciado t2-puzolana-s) 14.85)
    (= (tiempo-vaciado t3-puzolana-s) 14.61)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 41.07)
    (= (tiempo-vaciado t3-yeso) 25.76)
  )
