...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 4.21)
    (= (tiempo-vaciado t2-clinker) 2.98)
    (= (tiempo-vaciado t3-clinker) 0.61)
    (= (tiempo-vaciado t1-puzolana-h) 8.05)
    (= (tiempo-vaciado t2-puzolana-h) 23.63)
    (= (tiempo-vaciado t2-puzolana-s) 0.84)
    (= (tiempo-vaciado t3-puzolana-s) 0.01)
    (= (tiempo-vaciado t1-yeso) 8.81)
    (= (tiempo-vaciado t2-yeso) 23.69)
    (= (tiempo-vaciado t3-yeso) 1.08)
  )
