...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 9.50)
    (= (tiempo-vaciado t2-clinker) 11.36)
    (= (tiempo-vaciado t3-clinker) 10.97)
    (= (tiempo-vaciado t1-puzolana-h) 9.82)
    (= (tiempo-vaciado t2-puzolana-h) 6.11)
    (= (tiempo-vaciado t2-puzolana-s) 10.95)
    (= (tiempo-vaciado t3-puzolana-s) 10.59)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 2.75)
    (= (tiempo-vaciado t3-yeso) 3.93)
  )
