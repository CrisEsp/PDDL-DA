...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 13.61)
    (= (tiempo-vaciado t2-clinker) 9.48)
    (= (tiempo-vaciado t3-clinker) 9.38)
    (= (tiempo-vaciado t1-puzolana-h) 15.46)
    (= (tiempo-vaciado t2-puzolana-h) 13.15)
    (= (tiempo-vaciado t2-puzolana-s) 13.37)
    (= (tiempo-vaciado t3-puzolana-s) 8.77)
    (= (tiempo-vaciado t1-yeso) 22.50)
    (= (tiempo-vaciado t2-yeso) 14.37)
