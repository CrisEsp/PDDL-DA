...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 5.26)
    (= (tiempo-vaciado t2-clinker) 2.57)
    (= (tiempo-vaciado t3-clinker) 1.13)
    (= (tiempo-vaciado t1-puzolana-h) 4.56)
    (= (tiempo-vaciado t2-puzolana-h) 21.94)
    (= (tiempo-vaciado t2-puzolana-s) 1.29)
    (= (tiempo-vaciado t3-puzolana-s) 1.10)
    (= (tiempo-vaciado t1-yeso) 45.62)
    (= (tiempo-vaciado t2-yeso) 8.61)
    (= (tiempo-vaciado t3-yeso) 15.24)
  )
