...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 28.62)
    (= (tiempo-vaciado t2-clinker) 30.49)
    (= (tiempo-vaciado t3-clinker) 30.09)
    (= (tiempo-vaciado t1-puzolana-h) 28.95)
    (= (tiempo-vaciado t2-puzolana-h) 38.32)
    (= (tiempo-vaciado t2-puzolana-s) 30.08)
    (= (tiempo-vaciado t3-puzolana-s) 29.71)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 26.87)
    (= (tiempo-vaciado t3-yeso) 22.52)
  )
