...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 7.68)
    (= (tiempo-vaciado t2-clinker) 2.17)
    (= (tiempo-vaciado t3-clinker) 0.79)
    (= (tiempo-vaciado t1-puzolana-h) 6.87)
    (= (tiempo-vaciado t2-puzolana-h) 19.05)
    (= (tiempo-vaciado t2-puzolana-s) 2.45)
    (= (tiempo-vaciado t3-puzolana-s) 1.21)
    (= (tiempo-vaciado t1-yeso) 136.56)
    (= (tiempo-vaciado t2-yeso) 33.03)
    (= (tiempo-vaciado t3-yeso) 7.22)
  )
