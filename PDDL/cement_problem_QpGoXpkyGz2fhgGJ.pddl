...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 1.83)
    (= (tiempo-vaciado t2-clinker) 1.29)
    (= (tiempo-vaciado t3-clinker) 0.43)
    (= (tiempo-vaciado t1-puzolana-h) 2.45)
    (= (tiempo-vaciado t2-puzolana-h) 8.45)
    (= (tiempo-vaciado t2-puzolana-s) 2.20)
    (= (tiempo-vaciado t3-puzolana-s) 0.01)
    (= (tiempo-vaciado t1-yeso) 13.66)
    (= (tiempo-vaciado t2-yeso) 28.52)
    (= (tiempo-vaciado t3-yeso) 2.41)
  )
