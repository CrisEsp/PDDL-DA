  ...
  (:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 3.05)
    (= (tiempo-vaciado t2-clinker) 1.87)
    (= (tiempo-vaciado t3-clinker) 0.38)
    (= (tiempo-vaciado t1-puzolana-h) 3.52)
    (= (tiempo-vaciado t2-puzolana-h) 6.06)
    (= (tiempo-vaciado t2-puzolana-s) 1.97)
    (= (tiempo-vaciado t3-puzolana-s) 0.32)
    (= (tiempo-vaciado t1-yeso) 125.00)
    (= (tiempo-vaciado t2-yeso) 26.06)
    (= (tiempo-vaciado t3-yeso) 3.24)
  )
