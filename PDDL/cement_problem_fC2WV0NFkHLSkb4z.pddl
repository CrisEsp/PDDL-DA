...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 10.90)
    (= (tiempo-vaciado t2-clinker) 12.77)
    (= (tiempo-vaciado t3-clinker) 12.37)
    (= (tiempo-vaciado t1-puzolana-h) 14.38)
    (= (tiempo-vaciado t2-puzolana-h) 14.74)
    (= (tiempo-vaciado t2-puzolana-s) 12.36)
    (= (tiempo-vaciado t3-puzolana-s) 12.00)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 49.40)
    (= (tiempo-vaciado t3-yeso) 3.54)
  )
