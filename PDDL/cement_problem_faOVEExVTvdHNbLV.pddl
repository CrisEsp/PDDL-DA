...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 5.38)
    (= (tiempo-vaciado t2-clinker) 2.45)
    (= (tiempo-vaciado t3-clinker) 0.01)
    (= (tiempo-vaciado t1-puzolana-h) 4.47)
    (= (tiempo-vaciado t2-puzolana-h) 13.23)
    (= (tiempo-vaciado t2-puzolana-s) 2.22)
    (= (tiempo-vaciado t3-puzolana-s) 0.34)
    (= (tiempo-vaciado t1-yeso) 10.76)
    (= (tiempo-vaciado t2-yeso) 21.74)
    (= (tiempo-vaciado t3-yeso) 9.97)
  )
