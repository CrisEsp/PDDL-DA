...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 9.55)
    (= (tiempo-vaciado t2-clinker) 10.85)
    (= (tiempo-vaciado t3-clinker) 10.07)
    (= (tiempo-vaciado t1-puzolana-h) 13.23)
    (= (tiempo-vaciado t2-puzolana-h) 22.29)
    (= (tiempo-vaciado t2-puzolana-s) 9.41)
    (= (tiempo-vaciado t3-puzolana-s) 9.44)
    (= (tiempo-vaciado t1-yeso) 195.29)
    (= (tiempo-vaciado t2-yeso) 0.01)
    (= (tiempo-vaciado t3-yeso) 1.71)
  )
