...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 2.33)
    (= (tiempo-vaciado t2-clinker) 3.92)
    (= (tiempo-vaciado t3-clinker) 3.09)
    (= (tiempo-vaciado t1-puzolana-h) 2.68)
    (= (tiempo-vaciado t2-puzolana-h) 0.01)
    (= (tiempo-vaciado t2-puzolana-s) 6.02)
    (= (tiempo-vaciado t3-puzolana-s) 2.95)
    (= (tiempo-vaciado t1-yeso) 35.30)
    (= (tiempo-vaciado t2-yeso) 30.11)
    (= (tiempo-vaciado t3-yeso) 7.29)
  )
