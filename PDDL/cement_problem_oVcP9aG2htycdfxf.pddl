...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 12.59)
    (= (tiempo-vaciado t2-clinker) 11.46)
    (= (tiempo-vaciado t3-clinker) 9.91)
    (= (tiempo-vaciado t1-puzolana-h) 13.67)
    (= (tiempo-vaciado t2-puzolana-h) 26.75)
    (= (tiempo-vaciado t2-puzolana-s) 12.36)
    (= (tiempo-vaciado t3-puzolana-s) 10.02)
    (= (tiempo-vaciado t1-yeso) 21.36)
    (= (tiempo-vaciado t2-yeso) 49.67)
