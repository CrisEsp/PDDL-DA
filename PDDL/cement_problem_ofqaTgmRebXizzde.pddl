...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 7.33)
    (= (tiempo-vaciado t2-clinker) 2.73)
    (= (tiempo-vaciado t3-clinker) 2.03)
    (= (tiempo-vaciado t1-puzolana-h) 0.01)
    (= (tiempo-vaciado t2-puzolana-h) 25.52)
    (= (tiempo-vaciado t2-puzolana-s) 2.88)
    (= (tiempo-vaciado t3-puzolana-s) 2.03)
    (= (tiempo-vaciado t1-yeso) 136.40)
    (= (tiempo-vaciado t2-yeso) 11.88)
    (= (tiempo-vaciado t3-yeso) 0.65)
  )
