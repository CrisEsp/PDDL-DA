...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 15.19)
    (= (tiempo-vaciado t2-clinker) 13.96)
    (= (tiempo-vaciado t3-clinker) 13.40)
    (= (tiempo-vaciado t1-puzolana-h) 18.18)
    (= (tiempo-vaciado t2-puzolana-h) 29.27)
    (= (tiempo-vaciado t2-puzolana-s) 14.91)
    (= (tiempo-vaciado t3-puzolana-s) 11.67)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 27.66)
    (= (tiempo-vaciado t3-yeso) 12.94)
  )
