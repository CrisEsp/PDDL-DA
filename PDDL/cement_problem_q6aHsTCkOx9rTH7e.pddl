...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 17.94)
    (= (tiempo-vaciado t2-clinker) 13.89)
    (= (tiempo-vaciado t3-clinker) 11.72)
    (= (tiempo-vaciado t1-puzolana-h) 18.07)
    (= (tiempo-vaciado t2-puzolana-h) 26.12)
    (= (tiempo-vaciado t2-puzolana-s) 16.20)
    (= (tiempo-vaciado t3-puzolana-s) 11.12)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 28.22)
    (= (tiempo-vaciado t3-yeso) 24.72)
  )
