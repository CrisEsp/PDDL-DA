...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 13.89)
    (= (tiempo-vaciado t2-clinker) 10.01)
    (= (tiempo-vaciado t3-clinker) 7.78)
    (= (tiempo-vaciado t1-puzolana-h) 12.96)
    (= (tiempo-vaciado t2-puzolana-h) 26.40)
    (= (tiempo-vaciado t2-puzolana-s) 7.72)
    (= (tiempo-vaciado t3-puzolana-s) 6.92)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 27.11)
    (= (tiempo-vaciado t3-yeso) 13.24)
  )
