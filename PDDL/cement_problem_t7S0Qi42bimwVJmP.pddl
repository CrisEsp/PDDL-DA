...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 33.78)
    (= (tiempo-vaciado t2-clinker) 35.65)
    (= (tiempo-vaciado t3-clinker) 35.25)
    (= (tiempo-vaciado t1-puzolana-h) 34.10)
    (= (tiempo-vaciado t2-puzolana-h) 30.39)
    (= (tiempo-vaciado t2-puzolana-s) 35.24)
    (= (tiempo-vaciado t3-puzolana-s) 34.87)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 25.54)
    (= (tiempo-vaciado t3-yeso) 20.23)
  )
