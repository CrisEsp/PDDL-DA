...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 14.28)
    (= (tiempo-vaciado t2-clinker) 6.81)
    (= (tiempo-vaciado t3-clinker) 6.41)
    (= (tiempo-vaciado t1-puzolana-h) 10.45)
    (= (tiempo-vaciado t2-puzolana-h) 24.11)
    (= (tiempo-vaciado t2-puzolana-s) 6.40)
    (= (tiempo-vaciado t3-puzolana-s) 6.03)
    (= (tiempo-vaciado t1-yeso) 4.33)
    (= (tiempo-vaciado t2-yeso) 38.57)
