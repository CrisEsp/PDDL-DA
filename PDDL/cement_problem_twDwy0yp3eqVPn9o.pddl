...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 22.10)
    (= (tiempo-vaciado t2-clinker) 14.16)
    (= (tiempo-vaciado t3-clinker) 11.70)
    (= (tiempo-vaciado t1-puzolana-h) 16.34)
    (= (tiempo-vaciado t2-puzolana-h) 29.43)
    (= (tiempo-vaciado t2-puzolana-s) 14.32)
    (= (tiempo-vaciado t3-puzolana-s) 12.12)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 53.40)
    (= (tiempo-vaciado t3-yeso) 10.96)
  )
