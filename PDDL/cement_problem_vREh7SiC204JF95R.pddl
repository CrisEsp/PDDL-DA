...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 9.99)
    (= (tiempo-vaciado t2-clinker) 3.53)
    (= (tiempo-vaciado t3-clinker) 3.43)
    (= (tiempo-vaciado t1-puzolana-h) 9.17)
    (= (tiempo-vaciado t2-puzolana-h) 26.47)
    (= (tiempo-vaciado t2-puzolana-s) 6.88)
    (= (tiempo-vaciado t3-puzolana-s) 3.17)
    (= (tiempo-vaciado t1-yeso) 0.01)
    (= (tiempo-vaciado t2-yeso) 17.43)
    (= (tiempo-vaciado t3-yeso) 13.86)
  )
