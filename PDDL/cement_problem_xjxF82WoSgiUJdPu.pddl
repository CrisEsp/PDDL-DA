...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 1.07)
    (= (tiempo-vaciado t2-clinker) 2.61)
    (= (tiempo-vaciado t3-clinker) 0.69)
    (= (tiempo-vaciado t1-puzolana-h) 0.01)
    (= (tiempo-vaciado t2-puzolana-h) 15.87)
    (= (tiempo-vaciado t2-puzolana-s) 2.80)
    (= (tiempo-vaciado t3-puzolana-s) 1.44)
    (= (tiempo-vaciado t1-yeso) 95.40)
    (= (tiempo-vaciado t2-yeso) 41.72)
    (= (tiempo-vaciado t3-yeso) 14.26)
  )
