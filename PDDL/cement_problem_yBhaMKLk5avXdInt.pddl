...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 11.01)
    (= (tiempo-vaciado t2-clinker) 4.01)
    (= (tiempo-vaciado t3-clinker) 2.94)
    (= (tiempo-vaciado t1-puzolana-h) 8.74)
    (= (tiempo-vaciado t2-puzolana-h) 17.21)
    (= (tiempo-vaciado t2-puzolana-s) 4.78)
    (= (tiempo-vaciado t3-puzolana-s) 3.02)
    (= (tiempo-vaciado t1-yeso) 61.54)
    (= (tiempo-vaciado t2-yeso) 33.92)
