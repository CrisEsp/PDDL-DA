...
(:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 9.21)
    (= (tiempo-vaciado t2-clinker) 11.08)
    (= (tiempo-vaciado t3-clinker) 10.68)
    (= (tiempo-vaciado t1-puzolana-h) 9.54)
    (= (tiempo-vaciado t2-puzolana-h) 12.02)
    (= (tiempo-vaciado t2-puzolana-s) 10.67)
    (= (tiempo-vaciado t3-puzolana-s) 10.31)
    (= (tiempo-vaciado t1-yeso) 0.60)
    (= (tiempo-vaciado t2-yeso) 12.67)
