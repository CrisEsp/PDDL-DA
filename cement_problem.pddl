(define (problem cement-production-problem)
  ...
  (:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 0.95)
    (= (tiempo-vaciado t2-clinker) 0.67)
    (= (tiempo-vaciado t3-clinker) 0.26)
    (= (tiempo-vaciado t1-puzolana-h) 0.98)
    (= (tiempo-vaciado t2-puzolana-h) 2.02)
    (= (tiempo-vaciado t2-puzolana-s) 0.51)
    (= (tiempo-vaciado t3-puzolana-s) 0.35)
    (= (tiempo-vaciado t1-yeso) 31.25)
    (= (tiempo-vaciado t2-yeso) 6.06)
    (= (tiempo-vaciado t3-yeso) 3.57)
  )
