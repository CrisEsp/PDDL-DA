(define (problem cement-production-problem)
  ...
  (:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 4.17)
    (= (tiempo-vaciado t2-clinker) 0.88)
    (= (tiempo-vaciado t3-clinker) 1.14)
    (= (tiempo-vaciado t1-puzolana-h) 2.22)
    (= (tiempo-vaciado t2-puzolana-h) 20.51)
    (= (tiempo-vaciado t2-puzolana-s) 8.08)
    (= (tiempo-vaciado t3-puzolana-s) 1.06)
    (= (tiempo-vaciado t1-yeso) 213.33)
    (= (tiempo-vaciado t2-yeso) 41.71)
    (= (tiempo-vaciado t3-yeso) 10.93)
  )
