(define (problem cement-production-problem)
  ...
  (:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) 6.95)
    (= (tiempo-vaciado t2-clinker) 0.59)
    (= (tiempo-vaciado t3-clinker) 0.20)
    (= (tiempo-vaciado t1-puzolana-h) 4.44)
    (= (tiempo-vaciado t2-puzolana-h) 20.51)
    (= (tiempo-vaciado t3-puzolana-s) 0.24)
    (= (tiempo-vaciado t1-yeso) 160.00)
    (= (tiempo-vaciado t2-yeso) 41.03)
