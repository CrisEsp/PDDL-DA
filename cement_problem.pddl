(define (problem cement-production-problem)
  ...
  (:init
    ...
    ;; Tiempos de vaciado
    (= (tiempo-vaciado t1-clinker) -1.30)
    (= (tiempo-vaciado t2-clinker) -0.36)
    (= (tiempo-vaciado t3-clinker) -0.72)
    (= (tiempo-vaciado t1-puzolana-h) -1.62)
    (= (tiempo-vaciado t2-puzolana-h) -4.04)
    (= (tiempo-vaciado t2-puzolana-s) -0.71)
    (= (tiempo-vaciado t3-puzolana-s) -0.95)
    (= (tiempo-vaciado t1-yeso) -27.78)
    (= (tiempo-vaciado t2-yeso) -4.85)
    (= (tiempo-vaciado t3-yeso) -9.73)
  )
