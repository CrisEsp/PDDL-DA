...
#     # Actualizar estado_molinos
#     estado_molinos[molino.nombre] = estado
...
#                                 value="Encendido" if estado_molinos[molino.nombre.lower()] else "Apagado",  # Usar estado_molinos
#                                 width=130,
#                                 filled=True,
#                                 text_size=14,
...
# Variable global para el display del PDDL
pddl_display = None
